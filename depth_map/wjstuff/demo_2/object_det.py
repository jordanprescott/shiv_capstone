...
#     # Update global objects buffer
#     globals.objects_buffer = objects

#     return raw_frame, combined_mask, apple_detected, person_detected, red_circle_position