...
# UPDATE 01/23/25: Added functionality for 'object tracking': 
# in JSON file there is an optional 'target' feature: if true, will play
# radar sounds in direction of that object
...
_INPUT_FILE = BASE_DIR / "testobjects.JSON"
_HRTF_DIR = BASE_DIR / "HRTF/MIT/diffuse"
_PIPER_PATH = BASE_DIR / "piper/piper"
_MODEL_PATH = BASE_DIR / "piper/en-us-ryan-high.onnx"
_RADAR_SOUND_FILE = BASE_DIR / "sounds/radar-35955.wav"
    ...
    with subprocess.Popen(
        ...
        for task in tasks:
            ...
            if is_target:
                ...
                #loop the beep for n times; for example:
                num_loops_beep = 3
                for i in range(num_loops_beep):
                     ...
                     time.sleep(0.25) # can change delay of radar sounds
