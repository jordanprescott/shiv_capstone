...
def main(input_file, base_dir, xtts2_path, model_path):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        generate_and_play_audio_with_xtts2(xtts2_path, model_path, temp_dir, tasks)



main(_INPUT_FILE, _HRTF_DIR, _XTTS2_PATH, _TTS_MODEL_PATH)
