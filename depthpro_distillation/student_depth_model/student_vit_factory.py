...
class ViTConfig:
    ...
    timm_img_size: int = 96
    timm_patch_size: int = 8
...
VIT_CONFIG_DICT: Dict[ViTPreset, ViTConfig] = {
    "dinov2b8_96": ViTConfig(
        in_chans=3,
        embed_dim=768,
        encoder_feature_layer_ids=[2, 5, 8, 11],
        encoder_feature_dims = [192, 384, 768, 768],
        img_size=96,
        patch_size=8,
        timm_preset="vit_base_patch14_dinov2",
        timm_img_size=518,
        timm_patch_size=14,
    ),
}
